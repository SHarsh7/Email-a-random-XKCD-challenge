...
**Database:** <a href="https://www.freemysqlhosting.net/">freemysqlhosting</a>
...
`DB_DATABASE` `HTTP_HOST (optional)` `sender_email`

`DB_PASSWORD` `PROJECT_PATH (optional)` `sender_name`
